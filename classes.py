# we take a tkinter widget (usually a frame) via
#   inheritance and add widgets to it
#   That way, we can organize lots of widgets quite easily

import tkinter as tk
from tkinter import ttk

# see combining layout methods.py for reference
